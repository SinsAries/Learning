...
class Challenge:
    ...
    def new_challenge(self):
        self.key1 = list(map(int, bin(getrandbits(N_BITS-1))[2:].zfill(N_BITS-1)))+[0] # make sure key1 != key2 :>
        self.key2 = list(map(int, bin(getrandbits(N_BITS-1))[2:].zfill(N_BITS-1)))+[1] # make sure key1 != key2 :>
