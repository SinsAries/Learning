...
from selenium.webdriver.common.by import By  # Thêm dòng này để định nghĩa By
import time
import pickle

# Đường dẫn đến phiên bản EdgeDriver mới
...
# Mở lại trình duyệt và tải cookie đã lưu
driver = webdriver.Edge(service=service)
driver.get("https://codeforces.com")
load_cookies(driver, "codeforces_cookies.pkl")
driver.refresh()  # Làm mới trang để áp dụng cookie
